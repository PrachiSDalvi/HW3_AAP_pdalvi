...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so hw3_aap_pdalvi can be imported
    ├── src                <- Source code for use in this project.
    │   ├── hw3_aap_pdalvi <- Main package folder
    │   │   └── __init__.py    <- Marks as package
    │   │   └── hw3_aap_pdalvi.py  <- Just some placeholder Python source code file
    │
